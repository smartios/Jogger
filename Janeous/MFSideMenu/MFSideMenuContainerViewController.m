...
- (void)setDefaultSettings {
    ...
    self.menuWidth = UIScreen.mainScreen.bounds.size.width - 80;
...
- (void)toggleLeftSideMenuCompletion:(void (^)(void))completion {
    ...
    [[NSNotificationCenter defaultCenter]
     postNotificationName:@"menuAltered"
     object:nil];
}
...
shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    ...
    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"isTableViewDeleteEnable"] != nil && [[[NSUserDefaults standardUserDefaults] objectForKey:@"isTableViewDeleteEnable"] isEqualToString:@"yes"])
    {
        return YES;
    }
    else
...
- (void) handlePan:(UIPanGestureRecognizer *)recognizer {
    ...
    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"isPanEnabled"] && [[[NSUserDefaults standardUserDefaults] objectForKey:@"isPanEnabled"] isEqualToString:@"no"])
    {
        return;
    }
